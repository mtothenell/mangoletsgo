        ...
        <Modal visible={visible}>
            <View style={styles.container}>
                <View>
                    ...
                    <Text style={[globalStyles.textSmallB, { textAlign: 'center' }]}>
                        {challengeInfo}
                    </Text>
                </View>
                ...
                <View style={{ marginTop: 40, justifyContent: 'center', alignItems: 'center' }}>
                    <View style={styles.levels}>
                        <Image style={styles.mango} source={{ uri: mango1 }} />
                        <Text style={{ marginLeft: 20 }}>Klara minst 3.</Text>
                    </View>

                    <View style={styles.levels}>
                        <Image style={styles.mango} source={{ uri: mango2 }} />
                        <Text style={{ marginLeft: 20 }}>Klara minst 5.</Text>
                    </View>

                    <View style={styles.levels}>
                        <Image style={styles.mango} source={{ uri: mango3 }} />
                        <Text style={{ marginLeft: 20 }}>Klara minst 10.</Text>
                    </View>
                </View>
...
const styles = StyleSheet.create({
    ...
    levels: {
        flexDirection: 'row',
        justifyContent: 'center',
        alignItems: 'center', // Center the items in each row
        marginTop: 10,
    },
});
